...
if (isset($_POST["SUBMIT"])) {
    ...
    if ($classname == "" || $description == "" || $admin == "" || $code == "" || $image == "" || $room == "") {
...
<form action="" method="post" enctype= "multipart/form-data">
    ...
    <div class="form-group">
        <label for="description" style="margin-left: 25px;">Subject:</label>
        <input type="text" class="form-control" id="description" placeholder="Enter Subject" name="description" style="width: 75%; margin-left: 25px;" required>
    </div>
    <div class="form-group">
    ...
    <div class="form-group">
        <label style="margin-left: 25px;">Instructor/Admin:</label>
        <label style="margin-left: 25px;"><?php echo $_SESSION['fullname'];   ?></label>
    </div>
    <div class="form-group">
        <label style="margin-left: 25px;">Own:</label>
        <label style="margin-left: 25px;"><?php echo $_SESSION['username'];   ?></label>
    </div>
    <center>
        <input type="submit" name="SUBMIT" value="Submit" class="btn btn-primary">
        <button type="reset" class="btn btn-primary">Reset</button>
        <td colspan="2"><center><p><a href='admin.php'>Turn Back!</a></p></center></td>
    </center>
</form>
