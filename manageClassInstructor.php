...
<div  style="background: #e3eaf4;  border: dashed 1px #97b8ef; text-align: left">
    <center>
        <p><a href="instructor.php">Instructor Page</a>
        ...
        <table width="100%" border="1" style="border-collapse:collapse;">
            ...
            $sel_query="SELECT * FROM class WHERE own='$own'";
            ...
            while($row = mysqli_fetch_array($result)) { ?>
                <tr><td align="center"><?php echo $count; ?></td>
                    ...
                    <td align="center">
                        <a href="editClassInstructor.php?id=<?php echo $row["id"];  ?>">Edit Class</a>
                    </td>
                    <td align="center">
                        <a href="deleteClassInstructor.php?id=<?php echo $row["id"]; ?>">Delete Class</a>
                    </td>
                </tr>
