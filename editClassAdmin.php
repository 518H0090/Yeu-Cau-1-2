...
<center>
    ...
    <a href='manageClassAdmin.php'>View Account Updated Record</a>";
            ...
            <form name="form" method="post" action="" enctype= "multipart/form-data" style="background: #e3eaf4; width: 350px; height: 270px; border: dashed 1px #97b8ef; text-align: left">
                <center>
                    <table cellspacing=10 border=0>
                        ...
                        <tr>
                            <td>Instructor:</td>
                            <td><input type="text" name="instructor" placeholder="Enter Instructor" required value="<?php echo $row['instructor'];?>" /></td>
                        </tr>
                        <tr>
                            <td>Own:</td>
                            <td><input type="text" name="own" placeholder="Enter Owner" required value="<?php echo $row['own'];?>" /></td>
                        </tr>
                        <tr>
